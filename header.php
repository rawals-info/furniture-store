...
<div id="page" class="site">
    ...
    <header id="masthead" class="site-header" style="background: linear-gradient(135deg, #ffffff 0%, #f8f9fa 100%); box-shadow: 0 8px 32px rgba(0, 0, 0, 0.1); position: fixed; top: 0; left: 0; right: 0; z-index: 1000; width: 100%; backdrop-filter: blur(10px);">
        <!-- Top Bar -->
        <div class="top-bar" style="background: linear-gradient(135deg, #8B4513 0%, #A0522D 100%); color: #ffffff; padding: 8px 0; font-size: 14px; position: relative;">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-8">
                           <div class="contact-info" style="display: flex; gap: 20px; align-items: center; font-size: 14px;">
                            <span style="display: flex; align-items: center; gap: 5px;"><i class="fas fa-phone" style="color: #D2B48C;"></i> <a href="tel:(905) 270-0666" style="color: #ffffff; text-decoration: none;">(905) 270-0666</a></span>
                            <span style="display: flex; align-items: center; gap: 5px;"><i class="fas fa-envelope" style="color: #D2B48C;"></i> <a href="mailto:stylofurniture1456@gmail.com" style="color: #ffffff; text-decoration: none;">stylofurniture1456@gmail.com</a></span>
                            <span style="display: flex; align-items: center; gap: 5px;"><i class="fas fa-clock" style="color: #D2B48C;"></i> Open 7 days a week</span>
                        </div>
                    </div>
                    <div class="col-md-4 text-end">
                        <div class="social-links" style="display: flex; gap: 15px; justify-content: flex-end;">
                            <a href="#" style="display: inline-flex; align-items: center; justify-content: center; width: 28px; height: 28px; background-color: rgba(255,255,255,0.2); color: #ffffff; border-radius: 50%; transition: all 0.3s ease;"><i class="fab fa-facebook"></i></a>
                            <a href="#" style="display: inline-flex; align-items: center; justify-content: center; width: 28px; height: 28px; background-color: rgba(255,255,255,0.2); color: #ffffff; border-radius: 50%; transition: all 0.3s ease;"><i class="fab fa-instagram"></i></a>
                            <a href="#" style="display: inline-flex; align-items: center; justify-content: center; width: 28px; height: 28px; background-color: rgba(255,255,255,0.2); color: #ffffff; border-radius: 50%; transition: all 0.3s ease;"><i class="fab fa-pinterest"></i></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- Main Header -->
        <div class="main-header" style="background-color: #ffffff; padding: 15px 0; border-bottom: 1px solid rgba(139, 69, 19, 0.1);">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-4">
                        <div class="site-branding">
                            <div class="logo-container" style="display: flex; align-items: center; gap: 15px;">
                                <a href="<?php echo esc_url(home_url('/')); ?>" rel="home" style="text-decoration: none;">
                                    <img src="<?php echo esc_url(home_url('/wp-content/uploads/2025/10/logo_stylo.png')); ?>" alt="<?php bloginfo('name'); ?>" style="height: 45px; width: auto; max-width: 150px; object-fit: contain;">
                                </a>
